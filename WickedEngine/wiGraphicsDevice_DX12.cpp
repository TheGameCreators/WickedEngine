...
using namespace DX12_Internal;
	...
	void GraphicsDevice_DX12::UpdateTexture(const Texture* tex, uint32_t mipLevel, const void* copyboxptr, const void* data, uint32_t dataRowStride, CommandList cmd)
	{
	}
